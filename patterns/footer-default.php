...
$verve_site_info = has_custom_logo() ? '<!-- wp:site-logo {"width":200} /-->' : '<!-- wp:site-title /--><!-- wp:site-tagline /-->';

// Generate the copyright information.
$verve_copyright_info = esc_html__( 'Copyright &copy; ', 'verve' ) . esc_attr( gmdate( 'Y' ) );
?>
...
<footer class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-columns" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
		...
		<div class="wp-block-column" style="flex-basis:66.66%">
			...
			<?php echo wp_kses_post( $verve_site_info ); ?>
			...
			<p class="has-white-color has-text-color has-link-color">verve stands for: <em>twopalmscreative Block Theme</em>. It can be found in the <a href="https://github.com/twopalmscreative/verve">verve github repo.</a>&nbsp; The theme is stood up on WDSLab: <a href="https://verve.wdslab.com">https://verve.wdslab.com</a>&nbsp;</p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#f78766"}}}},"textColor":"white"} -->
			<p class="has-white-color has-text-color has-link-color"><?php echo wp_kses_post( $verve_copyright_info ); ?></p>
			<!-- /wp:paragraph -->
